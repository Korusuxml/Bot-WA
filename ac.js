...
global.mess = {
  ...
  superOwner: "_❗Perintah Ini Hanya Bisa Digunakan Oleh Owner Saya Saja 🥰 !_",
  ...
  response_failed:
    "_🚫 *Response Ke Server Gagal Coba Ketik. .Report untuk melaporkan masalah*_\n\n_Apabila Butuh Bantuan Silakan Hubungi Owner ",
  promote_admin: "Berhasil dijadikan admin",
  demote_admin: "Berhasil diberhentikan jadi admin",
...
global.singlemess = {
  ...
  antibadword:
    "_🚫 Ini Adalah Peringatan Terakhir_ \n\n_Apabila Pesan Kamu Mengandung *Toxic* Kamu Akan Di Kick_",
