        ...
        if (0 == o.isGroup && "offer" == o.status) {
          await dikzzydev.sendTextWithMentions(
            ...
            `BOT TIDAK DAPAT MENERIMA PANGGILAN ${
              ...
              o.from.split("@")[0]
            } KAMU AKAN DI *BLOCK* \n\nSilakan Hubungi Owner Untuk Membuka Block *Nomor Owner* https://wa.me/6281277811884`
          );
  ...
  dikzzydev.ev.on("connection.update", async (update) => {
    ...
    if (connection === "close") {
      ...
      reason === DisconnectReason.badSession
        ...
        dikzzydev.sendMessage("6281277811884@s.whatsapp.net", {text: "BOT ONLINE ✅"})
      /* =================| BOT CONNECTED |==================== */
      console.log(
        `${chalk.greenBright("[" + jammenit + "]")} ${chalk.greenBright(
          `
...
⡝⡵⡈⢟⢕⢕⢕⢕⣵⣿⣿⣿⣿⣿⣿⣿⣿⣿⣶⣶⣿⣿⣿⣿⣿⠿⠋⣀⣈⠙
⡝⡵⡕⡀⠑⠳⠿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⠿⠛⢉⡠⡲⡫⡪⡪⡣
FURINA BOT AI SUCCESSFUL CONNECTED `
        )}`
      );
      ...
      function readFileAndSendMessage() {
        fs.readFile(fileName, "utf8", (e, s) => {
          e ||
            (dikzzydev.sendMessage(s, { text: "_Furina Bot Berhasil Di Restart !_" }),
